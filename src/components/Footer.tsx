      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-8 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-2 max-w-sm text-sm text-ivory/70">
            Research prototype for low-resource multilingual morphology.
          </p>
        ...
        <div className="text-sm">
          ...
          <ul className="mt-3 space-y-2 text-ivory/80">
            ...
            <li><Link className="hover:text-sienna-soft" href="/experiment">Unseen-word experiment</Link></li>
            <li><Link className="hover:text-sienna-soft" href="/about">Methodology &amp; limitations</Link></li>
          </ul>
        </div>
        <div className="text-sm text-ivory/70">
          <p className="eyebrow !text-ivory/50">Integrity</p>
          <p className="mt-3">
            Quantitative results are <span className="text-sienna-soft">illustrative</span>. Linguistic forms carry
            provenance and verification status. Evenki and Chukchi entries await expert verification.
          </p>
        </div>
      </div>
      <div className="border-t border-ivory/10">
        <p className="mx-auto max-w-7xl px-5 py-4 font-mono text-[0.68rem] tracking-wider text-ivory/40 sm:px-8">
          MORPHOLENS · v0.1 · LOCAL DEMONSTRATION DATASET
        </p>
      </div>
    </footer>
  );
